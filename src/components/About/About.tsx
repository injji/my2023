  ...
  return (
    <div className={styles.about_wrap}>
      <div className={styles.about}>
        ...
        <div className={styles.hi} ref={(el) => (elementRefs.current[2] = el)}>
          <h3>안녕하세요👋</h3>
          <p>
            ...
            있어 포토샵, figma를 활용한 UI의 기획 및 디자인이 가능합니다. 또한
            웹 프로젝트의 팀장을 맡아본 적도 있어 다양한 역할을 맡은 동료들과
            긍정적으로 소통하고 스케쥴 관리의 경험도 가지고 있습니다. <br />제
            좌우명은 "어제보다 더 나은 내일을 만들자!" 입니다. 그렇기에 모르는
            것이 있다면 처음엔 스스로 답을 찾고자하지만 혼자만의 힘으로
            부족하다면 서슴없이 질문을 통해 답을 찾습니다. 배우고자 하는
            분야라면 배우는 것을 좋아하고 어려운 것이 있다면 빠르게 습득하기
            위해 방법을 가리지 않는 모습을 가지고 있습니다.
          </p>
        </div>
